...
myStartupHook = do
    ...
    spawn ("sleep 2 && trayer --edge top --align right --widthtype request --padding 4 --SetDockType true --SetPartialStrut false --expand true --transparent true --alpha 0 --tint 0x282c34 --height 22 --monitor primary")
    spawn ("sleep 2 && conky -c $HOME/.config/conky/doom-one-01.conkyrc")
    spawnOnce "nm-applet"
    spawnOnce "pnmixer"
    spawnOnce "/home/devid/.local/bin/x-settings.sh"
    spawn "flameshot"
